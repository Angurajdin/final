        ...
        <div class="p-5 rounded mt-3" id="toppage" style="background-color: #E4F1FB;">
            <div class="row">
                ...
                <div class="col" style="justify-content: left;">
                    ...
                    <input class="form-control-lg" list="datalistOptions" id="exampleDataList" placeholder="Type to search...">
                    ...
                    <a href="learn/learn.php?id=1&lang=cpp_lang">
                        <button type="button" class="btn btn-primary form-control-lg" style="background-color:#03338F;">Start Learning C &nbsp;&nbsp;
                    ...
                    <a href="learn/learn.php?id=1&lang=java_lang">
                        <button type="button" class="btn btn-primary" style="background-color:#03338F;">Start Learning Java &nbsp;&nbsp;
                            <i class="fas fa-arrow-right"></i>
                        </button>
                    </a>
                    <?php }  
                    ...
                    <a href="learn/learn.php?id=1&lang=python_lang">
                        <button type="button" class="btn btn-primary" style="background-color:#03338F;">Start Learning Python &nbsp;&nbsp;
                            <i class="fas fa-arrow-right"></i>
                        </button>
                    </a>
                    <?php } ?>
